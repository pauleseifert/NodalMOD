...
#Scandic shapes
import geopandas as gpd
#index = pd.Index(range[])
#student_df = student_df.set_index(index)
gdf_scandinavian_bidding_zones = gpd.read_file("data//shapes//scandinavian_bidding_zones.geojson").reset_index()
...
gdf_scandic = gdf_scandinavian_bidding_zones.rename(columns = {'bidding_zone':'CNTR_CODE'})
